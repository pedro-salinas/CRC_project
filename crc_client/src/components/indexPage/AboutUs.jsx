    ...
    return (
        <Container style={dynamicStyleInfo} id="info">
            ...
            >
                <Col xs={10}>
                    <h4>
                        Para explicarte cómo surgió este sistema, es importante
                        que te cuente un poco sobre mi propio proceso y quién
                        soy.
                    </h4>
                </Col>
            </Row>
            <Row className="pt-4 text-center" data-aos="fade-up">
                ...
                <Col sm={12} md={6}>
                    <h5 className="pt-4 text-start">
                        Soy Christopher Ramírez, Kinesiólogo musculoesquelético,
                        <strong> fundador de CRC Kinesiología.</strong>
                    </h5>
                    <h5 className="pt-4 text-start">
                        Pero no siempre fui quien soy ahora, ya que mi
                        transformación comenzó durante mis años de estudiante
                        universitario...
                    </h5>
                    <h3 className="pt-4">
                        <strong>
            ...
            >
                <Col xs={12}>
                    <h4 className="pt-4">
                        En ese tiempo solo me dedicaba a trabajar, estudiar y
                        por sobre todo ENTRENAR.
                    </h4>
                    <h4 className="pt-4">
            ...
            <Row className="pt-4 text-center" data-aos="fade-up">
                <h1>
                    ...
                    <strong>
                        me sentí abrumado por lo que significaba para mi futuro.
                    </strong>
                </h1>
            </Row>
            <Row className="pt-4" data-aos="fade-up">
                <Col sm={12} md={6}>
                    ...
                    <h3 className="pt-4 text-start">
                        <strong>
                            Sin emargo, no dejaría que me quitaran mi estilo de
                            vida.
                        </strong>
                    </h3>
                </Col>
            ...
            <Row className="pt-4 text-center" data-aos="fade-up">
                <Col sm={12} md={6} className="pt-4">
                    {!isMobile ? (
                        ...
                        <Image src={estilo} width="300px" />
                    )}
                </Col>
                <Col sm={12} md={6}>
                    <h5 className="pt-4 text-start">
                        Como me costaba moverme ante ejercicios y/o movimientos
                        de mayor intensidad y no podía entrenar, sólo me quedaba
                        una cosa ....
                    </h5>
                    <h3 className="pt-4">
                    ...
                    <h5 className="pt-4 text-start">
                        Así fue como aprendí aun más de kinesiología, pero no
                        con el método de mi universidad (ya que iba en tercero
                        en ese momento), sino que lo hice mediante cursos con{" "}
                        <strong>especialistas</strong> de Chile y el extranjero,
                        considerando enseñanzas de modelos terapéuticos
                        utilizados en <strong>EE.UU, Dinamarca, Canadá</strong>,
                        etc., con el fin de hallar una forma de tratamiento
                        efectiva.
                    </h5>
                    <h3 className="pt-4">
            ...
            <Row className="pt-4" data-aos="fade-up">
                <Col sm={12} md={6}>
                    <h5 className="pt-4 text-start">
                        ...
                        más completos fueran más posibilidades me entregaban
                        para descubrir que tratamiento era pertinente en cada
                        caso. De esta forma, mejore la evaluación misma en mi
                        caso y pude dar con el tratamiento que necesitaba.
                    </h5>
                    <h5 className="pt-4 text-start">
                ...
                <Col sm={12} md={6} className="pt-4 text-center">
                    {!isMobile ? (
                        <Image src={estudiar} width="350px" />
                    ) : (
                        <Image src={estudiar} width="300px" />
                    )}
                </Col>
            </Row>
            <Row
            ...
            >
                <Col xs={8}>
                    <h4 className="pt-4">
                        Sabía que no sólo yo estaba en esta situación, así que
                        me dediqué a ayudar a otros a lograr los cambios que
                        logré en mí mismo.
                    </h4>
                    <h4 className="pt-4">
                    ...
                    <h4 className="pt-4">
                        <strong>Me tomo 5 años perfeccionarlo</strong>, hasta
                        que finalmente decidí que era el momento correcto para
                        ponerlo a prueba.
                    </h4>
                </Col>
            </Row>
