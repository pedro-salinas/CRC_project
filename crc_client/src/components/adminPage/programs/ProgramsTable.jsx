...
import {
    columns,
    columnsForSelect,
} from "../../../utils/programsDataTableConfigs";

// Modales
import { ProgramsModalInsert } from "./ProgramsModalInsert";
import { ProgramsModalModify } from "./ProgramsModalModify";
import { ProgramsModalDelete } from "./ProgramsModalDelete";

export function ProgramsTable() {
    // Seleccion de un solo elemento
    const singleSelection = true;

    // Cargar tabla (tambien cargar los programas)
    ...
    // Valores default para cada programa
    ...
    return (
        <Card className="m-4 card-form">
            ...
            {/* Modal de modificación de programa */}
            <ProgramsModalModify
                show={showModify}
            ...
            {/* Modal de eliminación de programa */}
            <ProgramsModalDelete
                show={showDelete}
