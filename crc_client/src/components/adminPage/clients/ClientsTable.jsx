...
import {
    columns,
    columnsForSelect,
} from "../../../utils/clientsDataTableConfigs";

// Modales
import { ClientsModalInsert } from "./ClientsModalInsert";
import { ClientsModalModify } from "./ClientsModalModify";
import { ClientsModalDelete } from "./ClientsModalDelete";

export function ClientsTable() {
    // Seleccion de un solo elemento
    const singleSelection = true;

    // Cargar tabla (tambien cargar los clientes)
    ...
    // Valores default para cada cliente
