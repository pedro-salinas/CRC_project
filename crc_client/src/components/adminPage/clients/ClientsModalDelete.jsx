...
export function ClientsModalDelete({
    show,
    handleClose,
    setAlertType,
    setAlertText,
    ...
    // Handler de la eliminación de cliente
    const onSubmit = handleSubmit(async (values) => {
        ...
        const backendValidation = async () => {
            try {
                const res = await deleteClient(values._id);

                setLoading(false);

                setAlertType("success");
                setAlertText("Paciente eliminado correctamente");
                setShowAlert(true);
