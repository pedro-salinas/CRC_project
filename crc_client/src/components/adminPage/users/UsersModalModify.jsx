...
// Api
import { updateUser, updateCurrentUser } from "../../../api/user";

export function UsersModalModify({
    show,
    handleClose,
    setAlertType,
    setAlertText,
    ...
    const onSubmit = handleSubmit(async (values) => {
        ...
        const backendValidation = async () => {
            try {
                if (!staffModify) {
                    const res = await updateUser(values._id, values);
                } else {
                ...
                setAlertText("Usuario modificado correctamente");
                setShowAlert(true);
        ...
        <Modal show={show} onHide={handleClose}>
            <Form className="p-2" onSubmit={onSubmit}>
                <Modal.Header closeButton disabled={loading}>
                    <Modal.Title>
                        Modificar usuario: {defaultValues.name}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    ...
                    <Form.Group className="mb-3" controlId="password">
                        <Form.Label>
                            Nueva contraseña (dejar en blanco si no se quiere
                            cambiar)
                        </Form.Label>
                        <input
                            type="password"
